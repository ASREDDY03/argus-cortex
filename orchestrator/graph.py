...
from orchestrator.critic import run_critic
...
def build_graph(checkpoint_path: str = "checkpoints/cortex.db"):
    ...
    # --- Human Review -> Test Writer -> Critic -> PR Creator -> END ---
    builder.add_edge("human_review", "test_writer")
    builder.add_edge("test_writer", "critic")
    builder.add_edge("critic", "pr_creator")
